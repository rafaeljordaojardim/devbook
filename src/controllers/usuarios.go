...
func DeletaUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é posssivel deletar um usuário que não seja o seu"))
		return
	}
...
// SeguirUsuario permite que usuario siga o outro
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro := repositorio.PararDeSeguirUsuario(seguidorID, usuarioID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// BuscarSeguidores busca seguidores do usuario
...
// BuscarSeguindo busca qum esta seguindo
...
// AtualizarSenha atauliza senha do usuário
